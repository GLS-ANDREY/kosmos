...
def made_stone(x_stone, y_stone):
    ...
    stone_slovar = {"coord": pygame.Rect(x_stone,y_stone,50,50), "speed_x": random.randint(-3, 3), "speed_y": random.randint(2, 3),
...
def polet_stone(stone):
    ...
    stone["coord"].x += stone["speed_x"]/3.5
    stone["coord"].y += stone["speed_y"]/2.5
